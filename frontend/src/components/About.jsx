...
const About = () => {
  ...
  return (
    <div className="container mx-auto min-h-[900px] mt-20">
      <div className="flex items-center justify-between gap-5 flex-wrap lg:flex-nowrap">
        <div className="flex flex-col lg:w-3/4">
          <h2
            className="text-4xl mt-5 border-b-[16px] w-44"
            style={{
          ...
          <h1 className="mt-8 text-5xl sm:text-6xl md:text-7xl font-semibold leading-snug">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-5">
            <button
              ...
              className={`p-3 px-6 rounded-md border-2 ${
          ...
          <p className="mt-8 text-lg sm:text-xl md:text-2xl min-h-[300px] md:min-h-[330px]">
            {content}
          </p>
        </div>
